    ...
    public function getHeader($currencyId) :Array {
        if ($currencyId == 2) {
            return [
                ...
                trans('custom.aging_30_days_php'),
                trans('custom.aging_31_to_60_days_php'),
                trans('custom.aging_61_to_90_days_php'),
                trans('custom.aging_91_to_120_days_php'),
                trans('custom.aging_121_to_150_days_php'),
                trans('custom.aging_151_to_180_days_php'),
                trans('custom.aging_181_to_210_days_php'),
                trans('custom.aging_211_to_240_days_php'),
                trans('custom.aging_241_to_365_days_php'),
