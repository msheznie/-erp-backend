...
class TreasuryClearedDetails
{
    ...
    public $treasuryClearedStatus;
    public $treasuryClearedDate;
    public $treasuryClearedBy;
    ...
    public function getHeader(): Array
    {
        return [
            ...
            trans('custom.treasury_cleared_status'),
            trans('custom.treasury_cleared_date'),
            trans('custom.treasury_cleared_by'),
    ...
    /**
     * @param mixed $treasuryClearedStatus
     */
    public function setTreasuryClearedStatus($treasuryClearedStatus): void
    {
        $this->treasuryClearedStatus = $treasuryClearedStatus;
    }

    /**
     * @param mixed $treasuryClearedDate
     */
    public function setTreasuryClearedDate($treasuryClearedDate): void
    {
        $this->treasuryClearedDate = $treasuryClearedDate;
    }

    /**
     * @param mixed $treasuryClearedBy
     */
    public function setTreasuryClearedBy($treasuryClearedBy): void
    {
        $this->treasuryClearedBy = $treasuryClearedBy;
    }
}
