...
class BarcodeConfigurationAPIController extends AppBaseController
{
    ...
    public function getBarcodeConfigurationFormData(Request $request)
    {
        ...
        $paper_szie = [["value"=>1,"label"=>"A3"],["value"=>2,"label"=>"A4"]];
    ...
    public function genearetBarcode(Request $request)
    {
        ...
        $input = $request->all();
        $configuration = BarcodeConfiguration::first();
        ...
        {   
            ...
            {   
                ...
                if($font == 'Code 39')
               {
                    ...
                    //$pdf->Code128($val,10);
                    $pdf->Code39($val, true, false, 0.4, 10, true);
                    $pdf->StopTransform();
                    $barcodesCountPage++;
                    $barcodesCountTotal++;
