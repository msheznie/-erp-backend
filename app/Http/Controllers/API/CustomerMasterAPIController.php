...
use App\Services\API\SupplierMasterBulkUploadService;
...
{
    const DOCUMENT_ID_CUSTOMER = '58';
    const DOCUMENT_ID_SUPPLIER = '56';
    const DOCUMENT_ID_ITEM = '57';
 ...
 public function getPosCustomerSearch(Request $request)
{
    ...
    public function masterBulkUpload(request $request)
    {
        ...
        try {
            ...
            $input = $request->all();
            $document_id = $input['document_id'] ?? $input['documnet_id']; // Support both for backward compatibility
            ...
            if($document_id == self::DOCUMENT_ID_ITEM) {
