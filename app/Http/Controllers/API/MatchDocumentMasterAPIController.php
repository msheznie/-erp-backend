                ...
                if($matchDocumentMaster->matchingOption != 1) {
                    ...
                    foreach ($pvDetailExist as $item) {
                        ...
                        if ($item['addedDocumentSystemID'] == 11) {
                            //supplier invoice
//                            dd(Helper::roundValue($item['supplierInvoiceAmount'] - $payDetailMoreBooked->supplierPaymentAmount) > 0.00001);
                            dd($item['supplierInvoiceAmount'] < $payDetailMoreBooked->supplierPaymentAmount);
                            if (abs($item['supplierInvoiceAmount'] - $payDetailMoreBooked->supplierPaymentAmount) > 0.00001) {
