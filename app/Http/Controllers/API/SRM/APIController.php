...
define('VALIDATE_INVOICE_ATTACHMENT', 'VALIDATE_INVOICE_ATTACHMENT');
...
define('GET_CONTRACT_MASTER_DETAILS', 'GET_CONTRACT_MASTER_DETAILS');
...
class APIController extends Controller
{
    ...
    public function handleRequest(Request $request): array
    {
        switch ($request->input('request')) {
            ...
            case VALIDATE_INVOICE_ATTACHMENT:
                return $this->SRMService->validateInvoiceAttachment($request);
            ...
            case GET_ITEM_MASTER :
                return $this->SRMService->getItemMaster($request);
            ...
            case GET_CONTRACT_MASTER_DETAILS :
                return $this->SRMService->getContractMasterById($request);
            default:
                return [
                    'success'   => false,
