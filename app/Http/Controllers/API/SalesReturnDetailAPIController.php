            ...
            if ($remaingQty >= $currentItemData['qtyReturned']) {
                ...
                if($reasonCode){
                    ...
                    if($reasonCode->isPost == 0){
                        $chartOfAccountAssigned = ChartOfAccountsAssigned::where('chartOfAccountSystemID',$reasonCode->glCode)->where('companySystemID',$currentItemData['companySystemID'])->first();
