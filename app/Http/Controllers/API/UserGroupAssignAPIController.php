    ...
    public function checkUserGroupAccessRights(Request $request)
    {
        ...
        if (empty($userGroupAssign)) {
           ...
           // $accessRights = array('R' => false,'c' => false, 'E' => false, 'D' => false, 'P' => false);
            ...
            $accessRights = array('R' => $userGroupAssign->readonly, 'C' => $userGroupAssign->create ,'E' => $userGroupAssign->update, 'D' => $userGroupAssign->delete, 'P' => $userGroupAssign->print);
        }
