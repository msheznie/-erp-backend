        ...
        if ($budgetMasters) {
            ...
            foreach ($months as $month) {
                ...
                foreach ($glData as $gl) {
                    $detail = array_merge($commonDetail,array(
                    ...
                    array_push($budgetDetails,$detail);
                }

                collect($budgetDetails)->chunk(500)->each(function ($chunk) {
                    Budjetdetails::insert($chunk->toArray());
                });
