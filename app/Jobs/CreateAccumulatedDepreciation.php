    ...
    public function handle()
    {
        ...
        if($accumulated_amount > 0 && $accumulated_amount != null)
        {
            ...
            ->first();     
                ...
                {
                    $finalData = [];
                    $masterData = FixedAssetDepreciationMaster::find($depMaster->depMasterAutoID);
                    ...
                    ->where('depMasterAutoID', $depMaster->depMasterAutoID)
                    ...
                    $gl_data['createdUserID'] = \Helper::getEmployeeID();
