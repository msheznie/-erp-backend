...
use App\Services\hrms\employee\DesignationCreateUpdateNotificationService;
...
class DesignationCreateUpdateNotificationJob implements ShouldQueue
{
    ...
    {
        Log::useFiles( CommonJobService::get_specific_log_file('designation-create-update-notification') );
