...
use App\Services\hrms\employee\EmpDesignationUpdateNotificationService;
...
class EmpDesignationUpdateNotificationJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if (empty($this->dbName)) {
            ...
            $obj = new EmpDesignationUpdateNotificationService($this->companyId, $this->id, $this->masterDetails);
            $obj->execute();
        }
    }
}
