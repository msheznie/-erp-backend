                ...
                switch ($masterModel["documentSystemID"]) {
                    case 3: // GRV
                        ...
                        if ($masterData) {
                            ...
                            $data['documentTransAmount'] = \Helper::roundValue((($valEligible && !$rcmActivated) ? $masterData->details[0]->transAmount + $transVATAmount : $masterData->details[0]->transAmount) * -1);
                            ...
                            $data['documentLocalAmount'] = \Helper::roundValue((($valEligible && !$rcmActivated) ? $masterData->details[0]->localAmount + $localVATAmount : $masterData->details[0]->localAmount) * -1);
                            ...
                            $data['documentRptAmount'] = \Helper::roundValue((($valEligible && !$rcmActivated) ? $masterData->details[0]->rptAmount + $rptVATAmount : $masterData->details[0]->rptAmount) * -1);
                                ...
                                if(TaxService::isGRVRCMActivation($masterModel["autoID"])){
                                    ...
                                    if (!empty($taxDataOutputTransfer)) {
                                        ...
                                        if (!empty($chartOfAccountData)) {
                                            ...
                                            $data['documentTransAmount'] = \Helper::roundValue($transVATAmount) * -1;
                                            $data['documentLocalAmount'] = \Helper::roundValue($localVATAmount) * -1;
                                            $data['documentRptAmount'] = \Helper::roundValue($rptVATAmount) * -1;
                                            $data['timestamp'] = \Helper::currentDateTime();
                                            array_push($finalData, $data);
                    ...
                    case 24: // PRN - Purchase Return
                        ...
                        if ($masterData) {
                            ...
                            $data['documentTransAmount'] = \Helper::roundValue((($valEligible) ? $masterData->details[0]->transAmount + $transVATAmount : $masterData->details[0]->transAmount));
                            $data['documentLocalCurrencyID'] = $masterData->localCurrencyID;
                            $data['documentLocalCurrencyER'] = $masterData->localCurrencyER;
                            $data['documentLocalAmount'] = \Helper::roundValue((($valEligible) ? $masterData->details[0]->localAmount + $localVATAmount : $masterData->details[0]->localAmount));
                            $data['documentRptCurrencyID'] = $masterData->companyReportingCurrencyID;
                            $data['documentRptCurrencyER'] = $masterData->companyReportingER;
                            $data['documentRptAmount'] = \Helper::roundValue((($valEligible) ? $masterData->details[0]->rptAmount + $rptVATAmount : $masterData->details[0]->rptAmount));
                            $data['holdingShareholder'] = null;
                            $data['holdingPercentage'] = 0;
                            $data['nonHoldingPercentage'] = 0;
                            $data['createdDateTime'] = \Helper::currentDateTime();
                    ...
                    case 11: // SI - Supplier Invoice
                        ...
                        if ($masterData) {
                            ...
                            if ($masterData->documentType == 0 && $masterData->detail && count($masterData->detail) > 0 && $totalVATAmount > 0) {
