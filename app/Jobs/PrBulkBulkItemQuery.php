...
use App\Jobs\PrBulkBulkItemProcess;
...
class PrBulkBulkItemQuery implements ShouldQueue
{
     ...
     * @return void
     */
    public function __construct($page,$dataBase,$companyId,$financeCategoryMaster,$financeCategorySub,$requestID,$chunkDataSizeCounts,$isSearched,$searchVal,$budgetYear)
    {
    ...
    public function handle()
    {
        ...
        try {
            ...
            $itemMasters = ItemMaster::whereHas('itemAssigned', function ($query) use ($companyId) {
                                     ...
                                     ->whereDoesntHave('purchase_request_details', function($query) use ($requestID) {
                                        $query->where('purchaseRequestID', $requestID);
                                     })
