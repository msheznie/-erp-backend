...
/**
 * @SWG\Definition(
 *      definition="AssetDisposalDetailReferred",
 *      required={""},
 *      @SWG\Property(
 *          property="assetDisposalDetailReferredID",
 *          description="assetDisposalDetailReferredID",
 *          type="integer",
 *          format="int32"
 *      ),
 *      @SWG\Property(
 ...
 *      ),
 *      @SWG\Property(
 *          property="DISPOGLCODESystemID",
 *          description="DISPOGLCODESystemID",
 *          type="integer",
 *          format="int32"
 *      ),
 *      @SWG\Property(
 ...
 * )
 */
class AssetDisposalDetailReferred extends Model
{

    public $table = 'erp_fa_asset_disposaldetailreferredback';
    
    const CREATED_AT = 'timestamp';
    const UPDATED_AT = 'timestamp';

    protected $primaryKey = 'assetDisposalDetailReferredID';
     ...
     */
    protected $casts = [
        'assetDisposalDetailReferredID' => 'integer',
