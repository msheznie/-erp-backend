 ...
 * )
 */
class AttachmentSME extends Model
{
    ...
    public function getDocumentUrlAttribute(){
        return SME::s3_file_url($this->myFileName);
    }

    public function scopeDocument($query, $docID){
        return $query->where('documentID', $docID);
    }
