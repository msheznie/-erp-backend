...
/**
 * @SWG\Definition(
 *      definition="DirectPaymentReferback",
 *      required={""},
 *      @SWG\Property(
 *          property="directPaymentRefferedBackID",
 *          description="directPaymentRefferedBackID",
 *          type="integer",
 *          format="int32"
 *      ),
 *      @SWG\Property(
 ...
 *      ),
 *      @SWG\Property(
 *          property="toBankGlCodeSystemID",
 *          description="toBankGlCodeSystemID",
 *          type="integer",
 *          format="int32"
 *      ),
 *      @SWG\Property(
 ...
 * )
 */
class DirectPaymentReferback extends Model
{

    public $table = 'erp_directpaymentdetailsrefferedback';
    
    const CREATED_AT = 'timeStamp';
    const UPDATED_AT = 'timeStamp';

    protected $primaryKey = 'directPaymentRefferedBackID';
     ...
     */
    protected $casts = [
        'directPaymentRefferedBackID' => 'integer',
