...
class GRVDetails extends Model
{
    ...
    public $fillable = [
        ...
        'landingCost_RptCur',
        'poDisplayUnitCostSupTransCur',
        'effectiveUnitCostSupTransCur',
        'costAdjustmentAppliedYN',
    ...
    protected $casts = [
        ...
        'poDisplayUnitCostSupTransCur' => 'float',
        'effectiveUnitCostSupTransCur' => 'float',
        'costAdjustmentAppliedYN' => 'integer',
