...
/**
 * =============================================
 * -- File Name : ItemReturnDetails.php
 * -- Project Name : ERP
...
class ItemReturnDetails extends Model
{
    ...
    public $table = 'erp_itemreturndetails';
    
    const CREATED_AT = 'timestamp';
    const UPDATED_AT = 'timestamp';
    protected $primaryKey  = 'itemReturnDetailID';
    ...
    {
        return $this->belongsTo('App\Models\ItemReturnMaster', 'itemReturnAutoID', 'itemReturnAutoID');
    }
