...
class StockCountDetail extends Model
{
    ...
    public $table = 'erp_stock_count_details';
    
    const CREATED_AT = 'timestamp';
    const UPDATED_AT = 'timestamp';


    protected $primaryKey = 'stockCountDetailsAutoID';
    ...
    {
        return $this->belongsTo('App\Models\StockCount', 'stockCountAutoID', 'stockCountAutoID');
    }
