 ...
 * @version August 8, 2022, 8:42 am +04
 *
 * @method POSSOURCEShiftDetails findWithoutFail($id, $columns = ['*'])
 * @method POSSOURCEShiftDetails find($id, $columns = ['*'])
 * @method POSSOURCEShiftDetails first($columns = ['*'])
*/
class POSSOURCEShiftDetailsRepository extends BaseRepository
{
    /**
     * @var array
     */
    ...
    {
        return POSSOURCEShiftDetails::class;
    }
}
