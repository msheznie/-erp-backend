...
/**
 * Class POSStagMenuSalesMasterRepository
 * @package App\Repositories
 * @version July 26, 2022, 2:47 pm +04
 *
 * @method POSStagMenuSalesMaster findWithoutFail($id, $columns = ['*'])
 * @method POSStagMenuSalesMaster find($id, $columns = ['*'])
 * @method POSStagMenuSalesMaster first($columns = ['*'])
*/
class POSStagMenuSalesMasterRepository extends BaseRepository
{
    /**
     * @var array
     */
    ...
    {
        return POSStagMenuSalesMaster::class;
    }
}
