    ...
    public static function process($auditData)
    {
        ...
        if ($auditData['crudType'] == "U"){
            if($auditData['previosValue']['customerShortCode'] != $auditData['newValue']['customerShortCode']) {
                $modifiedData[] = ['amended_field' => "Secondary Code", 'previous_value' => ($auditData['previosValue']['customerShortCode']) ? $auditData['previosValue']['customerShortCode'] : '', 'new_value' => ($auditData['newValue']['customerShortCode']) ? $auditData['newValue']['customerShortCode'] : ''];
            }
            if($auditData['previosValue']['CustomerName'] != $auditData['newValue']['CustomerName']) {
                $modifiedData[] = ['amended_field' => "Customer Name", 'previous_value' => ($auditData['previosValue']['CustomerName']) ? $auditData['previosValue']['CustomerName'] : '', 'new_value' => ($auditData['newValue']['CustomerName']) ? $auditData['newValue']['CustomerName'] : ''];
            }
            if($auditData['previosValue']['ReportTitle'] != $auditData['newValue']['ReportTitle']) {
                $modifiedData[] = ['amended_field' => "Report Title", 'previous_value' => ($auditData['previosValue']['ReportTitle']) ? $auditData['previosValue']['ReportTitle'] : '', 'new_value' => ($auditData['newValue']['ReportTitle']) ? $auditData['newValue']['ReportTitle'] : ''];
            }
            if($auditData['previosValue']['customerAddress1'] != $auditData['newValue']['customerAddress1']) {
                $modifiedData[] = ['amended_field' => "Address 1", 'previous_value' => ($auditData['previosValue']['customerAddress1']) ? $auditData['previosValue']['customerAddress1'] : '', 'new_value' => ($auditData['newValue']['customerAddress1']) ? $auditData['newValue']['customerAddress1'] : ''];
            }

            if($auditData['previosValue']['customerAddress2'] != $auditData['newValue']['customerAddress2']) {
                $modifiedData[] = ['amended_field' => "Address 2", 'previous_value' => ($auditData['previosValue']['customerAddress2']) ? $auditData['previosValue']['customerAddress2'] : '', 'new_value' => ($auditData['newValue']['customerAddress2']) ? $auditData['newValue']['customerAddress2'] : ''];
            }
            ...
            if($auditData['previosValue']['custGLAccountSystemID'] != $auditData['newValue']['custGLAccountSystemID']) {
                ...
                $modifiedData[] = ['amended_field' => "Receivable Account", 'previous_value' => ($previousReceivableAccount) ? $previousReceivableAccount->AccountCode.'-'.$previousReceivableAccount->AccountDescription : '', 'new_value' => ($newReceivableAccount) ? $newReceivableAccount->AccountCode.'-'.$newReceivableAccount->AccountDescription : ''];
            }
            ...
            if($auditData['previosValue']['custAdvanceAccountSystemID'] != $auditData['newValue']['custAdvanceAccountSystemID']) {
                ...
                $modifiedData[] = ['amended_field' => "Advance Account", 'previous_value' => ($previousAdvanceAccount) ? $previousAdvanceAccount->AccountCode.'-'.$previousAdvanceAccount->AccountDescription : '', 'new_value' => ($newAdvanceAccount) ? $newUnbilledAccount->AccountCode.'-'.$newAdvanceAccount->AccountDescription : ''];
            }
            ...
            if($auditData['previosValue']['creditLimit'] != $auditData['newValue']['creditLimit']) {
                $modifiedData[] = ['amended_field' => "Credit Limit (USD)", 'previous_value' => ($auditData['previosValue']['creditLimit']) ? $auditData['previosValue']['creditLimit'] : '', 'new_value' => ($auditData['newValue']['creditLimit']) ? $auditData['newValue']['creditLimit'] : ''];
            }

            if($auditData['previosValue']['creditDays'] != $auditData['newValue']['creditDays']) {
                $modifiedData[] = ['amended_field' => "Credit Period", 'previous_value' => ($auditData['previosValue']['creditDays']) ? $auditData['previosValue']['creditDays'] : '', 'new_value' => ($auditData['newValue']['creditDays']) ? $auditData['newValue']['creditDays'] : ''];
            }

            if($auditData['previosValue']['customer_registration_no'] != $auditData['newValue']['customer_registration_no']) {
                $modifiedData[] = ['amended_field' => "Registration No", 'previous_value' => ($auditData['previosValue']['customer_registration_no']) ? $auditData['previosValue']['customer_registration_no'] : '', 'new_value' => ($auditData['newValue']['customer_registration_no']) ? $auditData['newValue']['customer_registration_no'] : ''];
            }

            if($auditData['previosValue']['customer_registration_expiry_date'] != $auditData['newValue']['customer_registration_expiry_date']) {
                $modifiedData[] = ['amended_field' => "Registration Expiry Date", 'previous_value' => ($auditData['previosValue']['customer_registration_expiry_date']) ? $auditData['previosValue']['customer_registration_expiry_date'] : '', 'new_value' => ($auditData['newValue']['customer_registration_expiry_date']) ? $auditData['newValue']['customer_registration_expiry_date'] : ''];
            }

            if($auditData['previosValue']['isCustomerActive'] != $auditData['newValue']['isCustomerActive']) {
                $modifiedData[] = ['amended_field' => "Is Active", 'previous_value' => ($auditData['previosValue']['isCustomerActive']==1) ? 'Yes' : 'No', 'new_value' => ($auditData['newValue']['isCustomerActive'] == 1) ? 'Yes' : 'No'];
            }
            ...
            if($auditData['previosValue']['consignee_name'] != $auditData['newValue']['consignee_name']) {
                $modifiedData[] = ['amended_field' => "Consignee Name", 'previous_value' => ($auditData['previosValue']['consignee_name']) ? $auditData['previosValue']['consignee_name'] : '', 'new_value' => ($auditData['newValue']['consignee_name']) ? $auditData['newValue']['consignee_name'] : ''];
            }

            if($auditData['previosValue']['consignee_contact_no'] != $auditData['newValue']['consignee_contact_no']) {
                $modifiedData[] = ['amended_field' => "Consignee Contact No", 'previous_value' => ($auditData['previosValue']['consignee_contact_no']) ? $auditData['previosValue']['consignee_contact_no'] : '', 'new_value' => ($auditData['newValue']['consignee_contact_no']) ? $auditData['newValue']['consignee_contact_no'] : ''];
            }

            if($auditData['previosValue']['consignee_address'] != $auditData['newValue']['consignee_address']) {
                $modifiedData[] = ['amended_field' => "Consignee Address", 'previous_value' => ($auditData['previosValue']['consignee_address']) ? $auditData['previosValue']['consignee_address'] : '', 'new_value' => ($auditData['newValue']['consignee_address']) ? $auditData['newValue']['consignee_address'] : ''];
            }

            if($auditData['previosValue']['payment_terms'] != $auditData['newValue']['payment_terms']) {
                $modifiedData[] = ['amended_field' => "Payment Terms", 'previous_value' => ($auditData['previosValue']['payment_terms']) ? $auditData['previosValue']['payment_terms'] : '', 'new_value' => ($auditData['newValue']['payment_terms']) ? $auditData['newValue']['payment_terms'] : ''];
            }
        }
