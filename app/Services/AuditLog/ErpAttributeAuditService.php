...
class ErpAttributeAuditService
{
    public static function process($auditData) 
    {
        ...
        if ($auditData['crudType'] == "C") {
            ...
            $modifiedData[] = ['amended_field' => "is_mandatory", 'previous_value' => '', 'new_value' => ($auditData['newValue']['is_mendatory']) ? 'True' : 'False'];
            ...
            $modifiedData[] = ['amended_field' => "is_mandatory", 'new_value' => ($auditData['newValue']['is_mendatory']) ? 'True' : 'False', 'previous_value' => ($auditData['previosValue']['is_mendatory']) ? 'True' : 'False'];
        }
            ...
            $modifiedData[] = ['amended_field' => "is_mandatory", 'new_value' => '', 'previous_value' => ($auditData['previosValue']['is_mendatory']) ? 'True' : 'False'];
