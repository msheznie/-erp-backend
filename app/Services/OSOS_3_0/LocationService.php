...
namespace App\Services\OSOS_3_0;
 ...
 class LocationService{
         ...
         try {
             ...
             if (in_array($statusCode, [200, 201])) {
                 ...
                 if(!isset($je['id'])){
                     ...
                     return $this->insertToLogTb($msg, 'error', 'Location', $this->companyId);
                 }

                 $this->insertOrUpdateThirdPartyPivotTable($je['id']);
                 $msg = "Api location {$this->operation} successfully finished";
                 return  $this->insertToLogTb($msg, 'info', 'Location', $this->companyId);
     ...
     function getLocationData()
     {
         ...
         if($this->postType != "POST"){
             $this->getReferenceId();
             $this->locationData['id'] = $this->locationUuId;
         }
     }
 }
