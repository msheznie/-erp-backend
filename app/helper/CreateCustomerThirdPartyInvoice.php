            ...
            if (!empty($approvalLevel)) {
                ...
                if (!empty($fromCompanyFinanceYear)) {
                    ...
                    if ($bank) {
                        ...
                        $customerInvoiceData['createdUserSystemID'] = $sourceModel['confimedByEmpSystemID'];
                        $customerInvoiceData['createdUserID'] = $sourceModel['confimedByEmpID'];
                        ...
                        $customerInvoiceData['approvedByUserSystemID'] = $sourceModel['confimedByEmpSystemID'];
                        $customerInvoiceData['approvedByUserID'] = $sourceModel['confimedByEmpID'];
