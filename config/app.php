...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Class aliases are now automatically registered via Composer autoload.
    | Custom aliases can be registered in AppServiceProvider or via
