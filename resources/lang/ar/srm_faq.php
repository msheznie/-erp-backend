...
return [
    ...
    'tender_faq_not_found' => 'لم يتم العثور على أسئلة المناقصة الشائعة',
    'tender_faq_deleted' => 'تم حذف أسئلة المناقصة بنجاح',
    "comment_field_is_required" => "حقل التعليق مطلوب.",
    "successfully_thread_closed" => "تم إغلاق الموضوع بنجاح",
