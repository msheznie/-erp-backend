<!-- Capitalizationdetailid Field -->
<div class="form-group col-sm-6">
    {!! Form::label('capitalizationDetailID', 'Capitalizationdetailid:') !!}
    {!! Form::number('capitalizationDetailID', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('assetCapitalizatioDetReferreds.index') !!}" class="btn btn-default">Cancel</a>
</div>
