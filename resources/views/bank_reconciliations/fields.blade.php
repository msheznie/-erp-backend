...
<!-- Bankglautoid Field -->
<div class="form-group col-sm-6">
    {!! Form::label('bankGLAutoID', 'Bankglautoid:') !!}
    {!! Form::number('bankGLAutoID', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Bankrecprimarycode Field -->
<div class="form-group col-sm-6">
    {!! Form::label('bankRecPrimaryCode', 'Bankrecprimarycode:') !!}
    {!! Form::text('bankRecPrimaryCode', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Bankrecasof Field -->
<div class="form-group col-sm-6">
    {!! Form::label('bankRecAsOf', 'Bankrecasof:') !!}
    {!! Form::date('bankRecAsOf', null, ['class' => 'form-control']) !!}
</div>

<!-- Openingbalance Field -->
<div class="form-group col-sm-6">
    {!! Form::label('openingBalance', 'Openingbalance:') !!}
    {!! Form::number('openingBalance', null, ['class' => 'form-control']) !!}
</div>

<!-- Closingbalance Field -->
<div class="form-group col-sm-6">
    {!! Form::label('closingBalance', 'Closingbalance:') !!}
    {!! Form::number('closingBalance', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('bankReconciliations.index') !!}" class="btn btn-default">Cancel</a>
</div>
