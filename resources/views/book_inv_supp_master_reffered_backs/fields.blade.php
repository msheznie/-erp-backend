<!-- Bookingsuppmasinvautoid Field -->
<div class="form-group col-sm-6">
    {!! Form::label('bookingSuppMasInvAutoID', 'Bookingsuppmasinvautoid:') !!}
    {!! Form::number('bookingSuppMasInvAutoID', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Secondaryrefno Field -->
<div class="form-group col-sm-6">
    {!! Form::label('secondaryRefNo', 'Secondaryrefno:') !!}
    {!! Form::text('secondaryRefNo', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Supplierinvoiceno Field -->
<div class="form-group col-sm-6">
    {!! Form::label('supplierInvoiceNo', 'Supplierinvoiceno:') !!}
    {!! Form::text('supplierInvoiceNo', null, ['class' => 'form-control']) !!}
</div>

<!-- Supplierinvoicedate Field -->
<div class="form-group col-sm-6">
    {!! Form::label('supplierInvoiceDate', 'Supplierinvoicedate:') !!}
    {!! Form::date('supplierInvoiceDate', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('bookInvSuppMasterRefferedBacks.index') !!}" class="btn btn-default">Cancel</a>
</div>
