<!-- Creditnotedetailsid Field -->
<div class="form-group col-sm-6">
    {!! Form::label('creditNoteDetailsID', 'Creditnotedetailsid:') !!}
    {!! Form::number('creditNoteDetailsID', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('creditNoteDetailsRefferdbacks.index') !!}" class="btn btn-default">Cancel</a>
</div>
