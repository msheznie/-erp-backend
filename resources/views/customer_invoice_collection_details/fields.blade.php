<!-- Customerinvoiceid Field -->
<div class="form-group col-sm-6">
    {!! Form::label('customerInvoiceID', 'Customerinvoiceid:') !!}
    {!! Form::number('customerInvoiceID', null, ['class' => 'form-control']) !!}
</div>

<!-- Invoicestatustypeid Field -->
<div class="form-group col-sm-6">
    {!! Form::label('invoiceStatusTypeID', 'Invoicestatustypeid:') !!}
    {!! Form::number('invoiceStatusTypeID', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-6">
    {!! Form::label('collectionDate', 'Collectiondate:') !!}
    {!! Form::date('collectionDate', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12 col-lg-12">
    {!! Form::label('actionRequired', 'Actionrequired:') !!}
    {!! Form::textarea('actionRequired', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('customerInvoiceCollectionDetails.index') !!}" class="btn btn-default">Cancel</a>
</div>
