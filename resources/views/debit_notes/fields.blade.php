...
<!-- Debitnotecode Field -->
<div class="form-group col-sm-6">
    {!! Form::label('debitNoteCode', 'Debitnotecode:') !!}
    {!! Form::text('debitNoteCode', null, ['class' => 'form-control']) !!}
</div>

<!-- Debitnotedate Field -->
<div class="form-group col-sm-6">
    {!! Form::label('debitNoteDate', 'Debitnotedate:') !!}
    {!! Form::date('debitNoteDate', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Debitamounttrans Field -->
<div class="form-group col-sm-6">
    {!! Form::label('debitAmountTrans', 'Debitamounttrans:') !!}
    {!! Form::number('debitAmountTrans', null, ['class' => 'form-control']) !!}
</div>

<!-- Debitamountlocal Field -->
<div class="form-group col-sm-6">
    {!! Form::label('debitAmountLocal', 'Debitamountlocal:') !!}
    {!! Form::number('debitAmountLocal', null, ['class' => 'form-control']) !!}
</div>

<!-- Debitamountrpt Field -->
<div class="form-group col-sm-6">
    {!! Form::label('debitAmountRpt', 'Debitamountrpt:') !!}
    {!! Form::number('debitAmountRpt', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('debitNotes.index') !!}" class="btn btn-default">Cancel</a>
</div>
