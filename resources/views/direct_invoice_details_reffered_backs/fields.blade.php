<!-- Directinvoicedetailsid Field -->
<div class="form-group col-sm-6">
    {!! Form::label('directInvoiceDetailsID', 'Directinvoicedetailsid:') !!}
    {!! Form::number('directInvoiceDetailsID', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('directInvoiceDetailsRefferedBacks.index') !!}" class="btn btn-default">Cancel</a>
</div>
