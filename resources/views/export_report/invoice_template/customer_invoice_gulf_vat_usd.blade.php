        ...
        <div class="row">
                <table class="table table-bordered table-striped table-sm" style="width: 100%;">
                    ...
                    <tr class="">
                        ...
                        <th colspan="4" style="text-align: center">Description of Goods/ Services</th>
                    ...
                    @foreach ($request->linePdoinvoiceDetails as $item)
                        ...
                        <tr style="border-top: 2px solid #333 !important;border-bottom: 2px solid #333 !important;background-color: white">
                            ...
                            <td colspan="4">{{$item->item_description}}</td>
        ...
        <table class="table table-bordered" style="width: 100%;">
            ...
            <tr class="theme-tr-head">
                ...
                @if($showSegmentColumn)
                    <th colspan="2" style="width:15%;text-align: center">Segment</th>
                @endif
        ...
        <div class="" style="">
            @else
                <div class="" style="">
                    ...
                    <table>
                        <tr>
                            <td colspan="3" width="100px"><span class="font-weight-bold" style="text-decoration: underline;">For Wire Transfer Instructions </span></td>
                            <td>-</td>
                        </tr>
                        <tr>
                            <td colspan="3" width="100px"><span class="font-weight-bold">Bank</span></td>
                            <td colspan="3"> -
                        ...
                        <tr>
                            <td colspan="3" width="100px"><span class="font-weight-bold">Branch </span></td>
                            <td colspan="3"> -
                                @if($request->secondaryLogoCompanySystemID)
                                    @if($secondaryBankAccount->contract && $secondaryBankAccount->contract->secondary_bank_account)
                        ...
                        <tr>
                            <td colspan="3" width="100px"><span class="font-weight-bold">Account No </span></td>
                            <td colspan="3"> -
                                @if($request->secondaryLogoCompanySystemID)
                                    @if($secondaryBankAccount->contract && $secondaryBankAccount->contract->secondary_bank_account)
                        ...
                        <tr>
                            <td colspan="3" width="100px"><span class="font-weight-bold">SWIFT Code </span></td>
                            <td colspan="3"> -
                                @if($request->secondaryLogoCompanySystemID)
                                    @if($secondaryBankAccount->contract && $secondaryBankAccount->contract->secondary_bank_account)
                    ...
                    <div class="" style="">
                        <table width="100%">
                            <tr>
                                ...
                                <td colspan="3" width="30%" style="">

                                </td>
                                <td colspan="3" width="20%" style="text-align:center; border-top: 1px solid black;margin-top: 7px;">
