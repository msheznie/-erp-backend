...
<!-- Jvcode Field -->
<div class="form-group col-sm-6">
    {!! Form::label('JVCode', 'Jvcode:') !!}
    {!! Form::text('JVCode', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Accjvselectedyn Field -->
<div class="form-group col-sm-6">
    {!! Form::label('accJVSelectedYN', 'Accjvselectedyn:') !!}
    {!! Form::number('accJVSelectedYN', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('hRMSJvMasters.index') !!}" class="btn btn-default">Cancel</a>
</div>
