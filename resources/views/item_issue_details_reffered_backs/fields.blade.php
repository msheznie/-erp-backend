<!-- Itemissuedetailid Field -->
<div class="form-group col-sm-6">
    {!! Form::label('itemIssueDetailID', 'Itemissuedetailid:') !!}
    {!! Form::number('itemIssueDetailID', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('itemIssueDetailsRefferedBacks.index') !!}" class="btn btn-default">Cancel</a>
</div>
