...
<!-- Issuecodesystem Field -->
<div class="form-group col-sm-6">
    {!! Form::label('issueCodeSystem', 'Issuecodesystem:') !!}
    {!! Form::number('issueCodeSystem', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Qtyfromissue Field -->
<div class="form-group col-sm-6">
    {!! Form::label('qtyFromIssue', 'Qtyfromissue:') !!}
    {!! Form::number('qtyFromIssue', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('itemReturnDetails.index') !!}" class="btn btn-default">Cancel</a>
</div>
