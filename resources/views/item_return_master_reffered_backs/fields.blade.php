<!-- Itemreturnautoid Field -->
<div class="form-group col-sm-6">
    {!! Form::label('itemReturnAutoID', 'Itemreturnautoid:') !!}
    {!! Form::number('itemReturnAutoID', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Itemreturncode Field -->
<div class="form-group col-sm-6">
    {!! Form::label('itemReturnCode', 'Itemreturncode:') !!}
    {!! Form::text('itemReturnCode', null, ['class' => 'form-control']) !!}
</div>

<!-- Returntype Field -->
<div class="form-group col-sm-6">
    {!! Form::label('ReturnType', 'Returntype:') !!}
    {!! Form::number('ReturnType', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Returnedby Field -->
<div class="form-group col-sm-6">
    {!! Form::label('ReturnedBy', 'Returnedby:') !!}
    {!! Form::text('ReturnedBy', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Returnrefno Field -->
<div class="form-group col-sm-6">
    {!! Form::label('ReturnRefNo', 'Returnrefno:') !!}
    {!! Form::text('ReturnRefNo', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('itemReturnMasterRefferedBacks.index') !!}" class="btn btn-default">Cancel</a>
</div>
