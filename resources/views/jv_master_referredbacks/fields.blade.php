...
<!-- Jvdate Field -->
<div class="form-group col-sm-6">
    {!! Form::label('JVdate', 'Jvdate:') !!}
    {!! Form::date('JVdate', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Recurringyear Field -->
<div class="form-group col-sm-6">
    {!! Form::label('recurringYear', 'Recurringyear:') !!}
    {!! Form::number('recurringYear', null, ['class' => 'form-control']) !!}
</div>

<!-- Jvnarration Field -->
<div class="form-group col-sm-12 col-lg-12">
    {!! Form::label('JVNarration', 'Jvnarration:') !!}
    {!! Form::textarea('JVNarration', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Jvtype Field -->
<div class="form-group col-sm-6">
    {!! Form::label('jvType', 'Jvtype:') !!}
    {!! Form::number('jvType', null, ['class' => 'form-control']) !!}
</div>

<!-- Isreverseaccyn Field -->
<div class="form-group col-sm-6">
    {!! Form::label('isReverseAccYN', 'Isreverseaccyn:') !!}
    {!! Form::number('isReverseAccYN', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('jvMasterReferredbacks.index') !!}" class="btn btn-default">Cancel</a>
</div>
