<!-- Modeimportdescription Field -->
<div class="form-group col-sm-6">
    {!! Form::label('modeImportDescription', 'Modeimportdescription:') !!}
    {!! Form::text('modeImportDescription', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('logisticModeOfImports.index') !!}" class="btn btn-default">Cancel</a>
</div>
