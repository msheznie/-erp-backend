<!-- Paymentbanktransferid Field -->
<div class="form-group col-sm-6">
    {!! Form::label('paymentBankTransferID', 'Paymentbanktransferid:') !!}
    {!! Form::number('paymentBankTransferID', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Banktransferdocumentcode Field -->
<div class="form-group col-sm-6">
    {!! Form::label('bankTransferDocumentCode', 'Banktransferdocumentcode:') !!}
    {!! Form::text('bankTransferDocumentCode', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Bankmasterid Field -->
<div class="form-group col-sm-6">
    {!! Form::label('bankMasterID', 'Bankmasterid:') !!}
    {!! Form::number('bankMasterID', null, ['class' => 'form-control']) !!}
</div>

<!-- Bankaccountautoid Field -->
<div class="form-group col-sm-6">
    {!! Form::label('bankAccountAutoID', 'Bankaccountautoid:') !!}
    {!! Form::number('bankAccountAutoID', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Exportedyn Field -->
<div class="form-group col-sm-6">
    {!! Form::label('exportedYN', 'Exportedyn:') !!}
    {!! Form::number('exportedYN', null, ['class' => 'form-control']) !!}
</div>

<!-- Exportedusersystemid Field -->
<div class="form-group col-sm-6">
    {!! Form::label('exportedUserSystemID', 'Exportedusersystemid:') !!}
    {!! Form::number('exportedUserSystemID', null, ['class' => 'form-control']) !!}
</div>

<!-- Exporteddate Field -->
<div class="form-group col-sm-6">
    {!! Form::label('exportedDate', 'Exporteddate:') !!}
    {!! Form::date('exportedDate', null, ['class' => 'form-control']) !!}
</div>

<!-- Submit Field -->
<div class="form-group col-sm-12">
    {!! Form::submit('Save', ['class' => 'btn btn-primary']) !!}
    <a href="{!! route('paymentBankTransferRefferedBacks.index') !!}" class="btn btn-default">Cancel</a>
</div>
