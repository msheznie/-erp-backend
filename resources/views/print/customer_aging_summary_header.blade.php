    ...
    <table style="width: 100%">
        <tr>
            ...
            <td valign="top" style="width: 55%; @if(isset($lang) && $lang === 'ar') text-align: right; @endif">
                <br><br>
                <span style="font-weight: bold; font-size: 12px;">{{trans('custom.customer_invoice_aging_summary')}}</span><br>
                <span style="font-weight: bold; font-size: 12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{trans('custom.as_of')}} {{ $fromDate }}</span>
            </td>
        </tr>
        <tr>
            <td valign="top" style="width: 45%; @if(isset($lang) && $lang === 'ar') text-align: right; @endif">
