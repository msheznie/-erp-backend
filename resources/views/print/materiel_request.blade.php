<html>
<head>
    <title>{{ __('custom.material_request_voucher') }}</title>
    <style>
        @page {
            margin-left: 30px;
            margin-right: 30px;
...
`             </span>
        ...
        <tr style="width: 100%">
            <td colspan="3" class="text-center">
                <h3>
                    {{ __('custom.material_request_voucher') }}
                </h3>
            </td>
        </tr>
    </table>
            ...
            <td style="width: 30%">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <span>
                                {{ \App\helper\Helper::dateFormat($entity->RequestedDate)}}
                            </span>
                        </td>
                    </tr>
                </table>
    ...
    <div style="margin-top: 30px">
        <table class="table table-bordered" style="width: 100%;">
            ...
            <tr style="background-color: #DEDEDE !important; border-color:#000">
                ...
                <th style="text-align: left;">{{ __('custom.qty_requested') }}</th>
            ...
            <tr width="100%">
                <td width="60%">
                    <table width="100%">
                        <tr>
                            <td width="100px">
                                <span style="font-weight:bold;">{{ __('custom.requested_by') }} :</span>
                            </td>
                            <td width="400px">
