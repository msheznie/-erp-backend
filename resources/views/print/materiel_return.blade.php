            ...
            <td style="width: 30%">
                <table>
                    <tr>
                        ...
                        <td>
                            <span>{{$entity->itemReturnCode}}</span>
                        </td>
                    </tr>
                    <tr>
                        <td width="70px">
                        ...
                        <td>
                            <span>
                                {{ \App\helper\Helper::dateFormat($entity->ReturnDate)}}
                            </span>
                        </td>
                    </tr>
                </table>
        ...
        <table class="table table-bordered" style="width: 100%;">
            ...
            @foreach ($entity->details as $item)
                <tr style="border-top: 2px solid #333 !important;border-bottom: 2px solid #333 !important;">
                    ...
                    <td style="padding-left: 5px;">
                        @if($item->uom_receiving)
                            {{$item->uom_receiving->UnitShortCode}}
                        @endif
                    </td>
                    <td style="padding-right: 5px;" class="text-right">{{$item->qtyIssued}}</td>
                    <td style="padding-right: 5px;" class="text-right">{{round($item->issueCostRpt,2)}}</td>
                    <td style="padding-left: 5px;" class="text-left">
                        {{$item->comments}}
                    </td>
                </tr>
