<html>
<head>
    <title>{{ __('custom.stock_received_voucher') }}</title>
    <style>
        @page {
            margin-left: 30px;
            margin-right: 30px;
...
`             </span>
        ...
        <tr style="width: 100%">
            <td colspan="3" class="text-center">
                <h3>
                    {{ __('custom.stock_received_voucher') }}
                </h3>
            </td>
        </tr>
    </table>
            ...
            <td style="width: 30%">
                <table>
                    <tr>
                        ...
                        <td>
                            <span>{{$entity->stockReceiveCode}}</span>
                        </td>
                    </tr>
                    <tr>
                        <td width="70px">
                        ...
                        <td>
                            <span>
                                {{ \App\helper\Helper::dateFormat($entity->receivedDate)}}
                            </span>
                        </td>
                    </tr>
                </table>
        ...
        <table class="table table-bordered" style="width: 100%;">
            ...
            @foreach ($entity->details as $item)
                <tr style="border-top: 2px solid #333 !important;border-bottom: 2px solid #333 !important;">
                    ...
                    <td style="padding-right: 5px;" class="text-right">{{$item->qty}}</td>
                    <td style="padding-left: 5px;" class="text-left">
                        {{$item->comments}}
                    </td>
                </tr>
