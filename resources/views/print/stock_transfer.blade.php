        ...
        <tr style="width:100%">
            <td style="width: 30%">
                <table>
                    <tr>
                        <td width="100px">
                            <span class="font-weight-bold">Location To</span>
                        </td>
                        <td width="10px">
                            <span class="font-weight-bold">:</span>
                        </td>
                        <td>
                            @if($entity->location_to_by)
                                {{$entity->location_to_by->wareHouseDescription}}
                            @endif
                        </td>
                    </tr>
                    <tr>
                        <td width="70px">
                            <span class="font-weight-bold">Location From</span>
                        </td>
                        <td width="10px">
                            <span class="font-weight-bold">:</span>
                        </td>
                        <td>
                            @if($entity->location_from_by)
                                {{$entity->location_from_by->wareHouseDescription}}
                            @endif
                        </td>
                    </tr>
                    <tr>
            ...
            <td style="width: 30%">
                <table>
                    <tr>
                        ...
                        <td>
                            <span>{{$entity->stockTransferCode}}</span>
                        </td>
                    </tr>
                    <tr>
                        <td width="70px">
                        ...
                        <td>
                            <span>
                                {{ \App\helper\Helper::dateFormat($entity->tranferDate)}}
                            </span>
                        </td>
                    </tr>
                </table>
