...
<!-- Fromtargetamount Field -->
<div class="form-group col-sm-6">
    {!! Form::label('fromTargetAmount', 'Fromtargetamount:') !!}
    {!! Form::number('fromTargetAmount', null, ['class' => 'form-control']) !!}
</div>

<!-- Totargetamount Field -->
<div class="form-group col-sm-6">
    {!! Form::label('toTargetAmount', 'Totargetamount:') !!}
    {!! Form::number('toTargetAmount', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('salesPersonTargets.index') !!}" class="btn btn-default">Cancel</a>
</div>
