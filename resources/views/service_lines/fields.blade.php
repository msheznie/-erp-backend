...
<div class="form-group col-sm-6">
    ...
    {!! Form::number('isMaster', null, ['class' => 'form-control']) !!}
</div>

<!-- Consolecode Field -->
<div class="form-group col-sm-6">
    {!! Form::label('consoleCode', 'Consolecode:') !!}
    {!! Form::text('consoleCode', null, ['class' => 'form-control']) !!}
</div>

<!-- Consoledescription Field -->
<div class="form-group col-sm-6">
    {!! Form::label('consoleDescription', 'Consoledescription:') !!}
    {!! Form::text('consoleDescription', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('serviceLines.index') !!}" class="btn btn-default">Cancel</a>
</div>
