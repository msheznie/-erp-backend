...
<!-- Stockadjustmentcode Field -->
<div class="form-group col-sm-6">
    {!! Form::label('stockAdjustmentCode', 'Stockadjustmentcode:') !!}
    {!! Form::text('stockAdjustmentCode', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Stockadjustmentdate Field -->
<div class="form-group col-sm-6">
    {!! Form::label('stockAdjustmentDate', 'Stockadjustmentdate:') !!}
    {!! Form::date('stockAdjustmentDate', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('stockAdjustments.index') !!}" class="btn btn-default">Cancel</a>
</div>
