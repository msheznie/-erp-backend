<!-- Stocktransferdetailsid Field -->
<div class="form-group col-sm-6">
    {!! Form::label('stockTransferDetailsID', 'Stocktransferdetailsid:') !!}
    {!! Form::number('stockTransferDetailsID', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('stockTransferDetailsRefferedBacks.index') !!}" class="btn btn-default">Cancel</a>
</div>
