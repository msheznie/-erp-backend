...
<!-- Refno Field -->
<div class="form-group col-sm-6">
    {!! Form::label('refNo', 'Refno:') !!}
    {!! Form::text('refNo', null, ['class' => 'form-control']) !!}
</div>

<!-- Tranferdate Field -->
<div class="form-group col-sm-6">
    {!! Form::label('tranferDate', 'Tranferdate:') !!}
    {!! Form::date('tranferDate', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Companyfromsystemid Field -->
<div class="form-group col-sm-6">
    {!! Form::label('companyFromSystemID', 'Companyfromsystemid:') !!}
    {!! Form::number('companyFromSystemID', null, ['class' => 'form-control']) !!}
</div>

<!-- Companyfrom Field -->
<div class="form-group col-sm-6">
    {!! Form::label('companyFrom', 'Companyfrom:') !!}
    {!! Form::text('companyFrom', null, ['class' => 'form-control']) !!}
</div>

<!-- Companytosystemid Field -->
<div class="form-group col-sm-6">
    {!! Form::label('companyToSystemID', 'Companytosystemid:') !!}
    {!! Form::number('companyToSystemID', null, ['class' => 'form-control']) !!}
</div>

<!-- Companyto Field -->
<div class="form-group col-sm-6">
    {!! Form::label('companyTo', 'Companyto:') !!}
    {!! Form::text('companyTo', null, ['class' => 'form-control']) !!}
</div>

<!-- Locationto Field -->
<div class="form-group col-sm-6">
    {!! Form::label('locationTo', 'Locationto:') !!}
    {!! Form::number('locationTo', null, ['class' => 'form-control']) !!}
</div>

<!-- Locationfrom Field -->
<div class="form-group col-sm-6">
    {!! Form::label('locationFrom', 'Locationfrom:') !!}
    {!! Form::number('locationFrom', null, ['class' => 'form-control']) !!}
</div>
...
<!-- Fullyreceived Field -->
<div class="form-group col-sm-6">
    {!! Form::label('fullyReceived', 'Fullyreceived:') !!}
    {!! Form::number('fullyReceived', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('stockTransferRefferedBacks.index') !!}" class="btn btn-default">Cancel</a>
</div>
