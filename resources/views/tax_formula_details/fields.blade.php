<!-- Taxcalculationformulaid Field -->
<div class="form-group col-sm-6">
    {!! Form::label('taxCalculationformulaID', 'Taxcalculationformulaid:') !!}
    {!! Form::number('taxCalculationformulaID', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12 col-lg-12">
    {!! Form::label('taxMasters', 'Taxmasters:') !!}
    {!! Form::textarea('taxMasters', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('taxFormulaDetails.index') !!}" class="btn btn-default">Cancel</a>
</div>
