...
Route::post('getBudgetGenerateDetailByRowId', 'CompanyBudgetPlanningAPIController@getBudgetGenerateDetailByRowId')->name("Get budget generate detail by row id");
...
Route::post('company_budget_plannings/{id}/update', 'CompanyBudgetPlanningAPIController@updateCompanyBudgetPlanning')->name('Update company budget planning via POST');
...
Route::post('department-budget-detail-comments/delete', 'DepartmentBudgetDetailCommentAPIController@destroy')->name('Delete department budget detail comment');
