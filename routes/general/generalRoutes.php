...
Route::get('getPendingDocumentsByFinancePeriod', 'PendingApprovalDocumentsAPIController@getPendingDocumentsByFinancePeriod')->name('Get pending documents by finance period');
