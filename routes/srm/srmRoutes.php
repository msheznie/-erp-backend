...
Route::post('cloneTender', 'TenderMasterAPIController@cloneTender')->name("Clone tender");
...
Route::post('getBudgetGlList', 'TenderMasterAPIController@getBudgetGlList')->name("Get tender master data");
